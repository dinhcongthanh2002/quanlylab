...
<div class="col-sm-10 col-sm-offset-2 col-md-10 col-md-offset-2 col-lg-10 col-lg-offset-2 main">	
	<div class="row">
		<ol class="breadcrumb">
			...
			<li class=""><a href="room">Phòng</a></li>
	...
	<div class="sidebar-form">
		<div class="container-fluid">
			...
			<form class="frm_transfer">
				...
				<div class="form-group">
					<label>Người CTN</label>
					<input type="text" name="personincharge" class="form-control" required>
				</div>
				<div class="form-group">
					<button class="btn btn-primary" type="submit">Giao</button>
					<button class="btn btn-danger cancel-transfer" type="button" >Thoát</button>
				</div>
			</form>
		</div>
	</div>
		...
		<div class="modal-content">
			<form class="frm_returnroom">
				<div class="modal-header">
					...
					<h4 class="modal-title" id="myModalLabel">Số lượng</h4>
				</div>
