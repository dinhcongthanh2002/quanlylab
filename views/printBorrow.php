		...
		<tbody>
			<tr>
				...
				<td style="text-align:center; font-size:13pt; font-family:'Times New Roman'">
					<p style="margin:0;padding:0;">Cộng Hoà xã hội chủ nghĩa Việt Nam</p>
					<p style="margin:0;padding:0;font-weight:bold;">TRƯỜNG ĐẠI HỌC TÀI NGUYÊN VÀ MÔI TRƯỜNG HÀ NỘI</p>
					<p style="margin:0;padding:0;">Hà Nội</p>
				</td>
				<td><img src="logo.png" class="img-responsive" style="visibility: hidden" /></td>
			</tr>
			<tr>
				<td></td>
				<td style="text-align:center; font-weight:bold; padding:30px 0; font-size:18pt; font-family:'Bookman Old Style'; text-transform: uppercase;">Biên lai</td>
				<td></td>
			</tr>
			<tr>
				<td colspan="3" style="font-size:16pt;">Tên: <?php echo $data[0]['m_fname']; ?> <?php echo $data[0]['m_lname']; ?></td>
			</tr>
			<tr>
				<td colspan="3" style="font-size:16pt;">phòng: <?php echo ucfirst($data[0]['rm_name']); ?></td>
			</tr>
			<tr>
				<td colspan="3">
					<table style="width:100%; border:1px solid #000; border-bottom: none;" cellpadding="0" cellspacing="0">
						<thead>
							<tr>
								<th style="padding:5px; font-size:14pt; font-family:'Calibri'; border-bottom:1px solid #000;">Loại</th>
								<th style="padding:5px; font-size:14pt; font-family:'Calibri'; border-bottom:1px solid #000; border-left:1px solid #000;">Hãng</th>
							</tr>
						</thead>
						<tbody>
