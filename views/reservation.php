		...
		<div class="row">
			<div class="col-md-12">
				<ul class="nav nav-pills">
					<li class="active"><a href="#pending" data-toggle="tab"><i class="fa fa-list"></i>&nbsp;&nbsp;Chờ</a></li>
					<li><a href="#reserved" data-toggle="tab"><i class="fa fa-question"></i>&nbsp;&nbsp;Chấp nhận</a></li>
				</ul>
			</div>
		</div>
			...
			<div class="modal-content">
				<form class="frm_cancelreservation">
					<div class="modal-header">
						...
						<h4 class="modal-title" id="myModalLabel">Huỷ</h4>
					</div>
